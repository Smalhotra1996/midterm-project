...
('1956-09-24','susanil', 'susaan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'),
('1986-04-17','sunakshi', 'susdan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'),
('1936-05-27','Mishi', 'susann@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'),
('1946-02-24','sana', 'sus,san@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'),
('1996-01-27','susaan', 's,uusan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'),
('1996-01-27','suban', 'sussan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'),
('1996-01-27','sushant', 'suusan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u')
=======
=======
INSERT INTO users (id,register_on, name, email, password)
>>>>>>> 1ae1583c7d6dbe499eaca6c2ba14db2c5e9d3946
...
<<<<<<< HEAD
VALUES('1986-09-17','susan', 'susan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
VALUES('1956-09-24','susanil', 'susaan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
VALUES('1986-04-17','sunakshi', 'susdan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
VALUES('1936-05-27','Mishi', 'susann@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
VALUES('1946-02-24','sana', 'sussan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
VALUES('1996-01-27','susaan', 'suusan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
VALUES('1996-01-27','suban', 'sussan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
VALUES('1996-01-27','sushant', 'suusan@gmail.com','$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u') 
>>>>>>> 1d7717925606b3417721333372e3747cc384d810




<<<<<<< HEAD
INSERT INTO quizzes (create_on, title, description, visibility, photo_url,category )
VALUES('2016-05-12','SQL BASIC QUIZ ','There are a list of sql quizzes that will clear your sql concepts. We have divided the SQL quizzes into different parts such as SQL basic concepts quiz, CRUD operation quiz, JOIN quiz, miscellaneous quiz etc.','https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://coursera-course-photos.s3.amazonaws.com/7a/569080aab711e79d97bf25c196049d/1200px-square-dark.jpg?auto=format%2Ccompress&dpr=1','Technical'),
('2011-01-10','SQL CRUD Quiz','There are a list of sql quizzes that will clear your sql concepts. We have divided the SQL quizzes into different parts such as SQL basic concepts quiz, CRUD operation quiz, JOIN quiz, miscellaneous quiz etc.',' https://www.kdnuggets.com/wp-content/uploads/sql.jpg','Technical'),
('1994-03-11', 'BAsic cooking','What do you know about basic cooking methods? Almost everyone knows how to boil an egg, make spaghetti, or a simple grilled cheese sandwich. One of the initial things you learn when you begin to cook for yourself or your family...','https://i.guim.co.uk/img/media/acb02b9fc3e12cb965441dc1d77eed8d19572afd/0_150_4535_2723/master/4535.jpg?width=465&quality=45&auto=format&fit=max&dpr=2&s=5f9b928b8d484192ee2ff5c2ecc083d5','ART'),
 ('2011-04-11','10th Grade Math','10th grade math topics are planned and covered all the lessons in different segments. 10th grade math help is provided for the 10th grade students in all segments to cover all the math lesson plans which are categorized into Arithmetic, Algebra, Geometry, Mensuration and Trigonometry.
...
Each topic that are covered in 11 and 12 grade math, concepts is enlightened with a summarization which includes important theorems, results and formula are discussed in each topic with numerous types of solved examples. Sufficient number of problems have been inserted in grade 11 and 12 practice math task worksheets beginning with easier followed gradually by harder ones.
 ...
 ('1778-02-21','eQuiz.Me','Free English quiz tests :white_check_mark: for ESL learners to do online. Test your English grammar and vocabulary FREE. With answers. For ESL learners and teachers.','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShLoc6OI7DR5QA0lVUECkOJKSRMvqWTtIYaQ&usqp=CAU','language')


INSERT INTO (questions)
 VALUES ('Question 1. What is three fifth of 100?','Question 2. If David’s age is 27 years old in 2011. What was his age in 2003?',
'Question 3. What is the remainder of 21 divided by 7?','Question 4. What is 7% equal to?'.'Question 5. I am a number. I have 7 in the ones place. I am less than 80 but greater than 70. What is my number?'),
 ('1) What is the full form of SQL?','2) Which of the following is not a valid SQL type?','3) Which of the following is not a DDL command?','4) Which of the following are TCL commands?','5) Which statement is used to delete all rows in a table without having the action logged?'),
('Question 1.The correct description for boiling is', 'Question 2.The correct description for simmering is', 'Question 3.The correct description for poaching is', 'Questin 4.Braising requires the food to be'),
('Q1.Which numbers are factors of 20? Select all that apply.','Q2.Which number is a factor of 15?','Q3. Besides 4 and 1, what is one factor of 4?'),
('Q1. Is g(x) the inverse function of f(x)?f(x)=x–7  g(x)=x+7', 'Q2.s f(x) the inverse function f g(x)?  f(x)=x–9   g(x)=x+9'),
('Q1. The lines that describe the outer edges of objects and figures are called _____.', 'Q2.2. A drawing technique for shading using parallel lines that cross over other parallel lines,', 'Q3. 3. If a sheet of paper is vertical, which position is it in?' ),
('Q1. "How are you?" in French', 'Q2. How to answer "how are you?', 'Q3. "What is your name?" in French'),
('Q1. Click the best synonym for load:'),
('Q1. The students in our college are _________ in other colleges.', 'Q2. If she had had budget, she ________ it before.', 'Q3. Indonesia is a country ________ thousands of small and big islands, and it is ________ most dispersed country in the world.')
=======
INSERT INTO quizzes (create_on, title, description, visibility, photo_url,category ) 
VALUES('2016-05-12','SQL BASIC QUIZ ','There are a list of sql quizzes that will clear your sql concepts. We have divided the SQL quizzes into different parts such as SQL basic concepts quiz, CRUD operation quiz, JOIN quiz, miscellaneous quiz etc.','https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://coursera-course-photos.s3.amazonaws.com/7a/569080aab711e79d97bf25c196049d/1200px-square-dark.jpg?auto=format%2Ccompress&dpr=1','Technical')
VALUES('2011-01-10','SQL CRUD Quiz','There are a list of sql quizzes that will clear your sql concepts. We have divided the SQL quizzes into different parts such as SQL basic concepts quiz, CRUD operation quiz, JOIN quiz, miscellaneous quiz etc.',' https://www.kdnuggets.com/wp-content/uploads/sql.jpg','Technical')
VALUES('1994-03-11', 'COOK (PROFESSIONAL COOK 3)','“Cook” means a person who performs all phases of kitchen activities including the preparation and
presentation of vegetables, soups, sauces, meat, fish and poultry, cold kitchen items; desserts, baking,
pastry; basic menu planning/costing as well as knowledge of safety, sanitation and food storage, and who
has a knowledge of human and customer relations.  A Professional Cook 3 will have met all of the requirements of the national Red Seal standard for Cook.
They usually work under limited supervision and will be competent at the major techniques and principles
used in cooking, baking, and other aspects of food preparation. In addition to a sound set of cooking
skills, a professional cook at this level should be able to plan and cost menus and recipes, and have an
understanding of the communication skills that will be necessary to begin to take a leadership role in the
kitchen.  For detailed information on the scope of knowledge and skills taught and assessed in this program refer
to the Program Outline, available on the ITA website.','https://i.guim.co.uk/img/media/acb02b9fc3e12cb965441dc1d77eed8d19572afd/0_150_4535_2723/master/4535.jpg?width=465&quality=45&auto=format&fit=max&dpr=2&s=5f9b928b8d484192ee2ff5c2ecc083d5','ART')
VALUES ('2011-04-11','10th Grade Math','10th grade math topics are planned and covered all the lessons in different segments. 10th grade math help is provided for the 10th grade students in all segments to cover all the math lesson plans which are categorized into Arithmetic, Algebra, Geometry, Mensuration and Trigonometry.
=======
...
INSERT INTO (questions)
 VALUES ('Question 1. What is three fifth of 100?','Question 2. If David’s age is 27 years old in 2011. What was his age in 2003?',
'Question 3. What is the remainder of 21 divided by 7?','Question 4. What is 7% equal to?'.'Question 5. I am a number. I have 7 in the ones place. I am less than 80 but greater than 70. What is my number?')
 VALUES('1) What is the full form of SQL?','2) Which of the following is not a valid SQL type?','3) Which of the following is not a DDL command?','4) Which of the following are TCL commands?','5) Which statement is used to delete all rows in a table without having the action logged?')
VALUES('')
>>>>>>> 1d7717925606b3417721333372e3747cc384d810
=======
